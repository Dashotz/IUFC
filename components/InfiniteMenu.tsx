...
class InfiniteGridMenu {
  ...
  private init(onInit?: InitCallback): void {
    ...
    vec2.set(this.drawBufferSize, this.canvas.clientWidth, this.canvas.clientHeight)
        ...
        (item, index) =>
          new Promise<HTMLImageElement>((resolve, reject) => {
            ...
            img.onerror = () => {
              ...
              placeholderCtx.fillText(`${index + 1}`, cellSize / 2, cellSize / 2)
...
const InfiniteMenu: FC<InfiniteMenuProps> = ({ items = [], scale = 1.0 }) => {
  ...
  useEffect(() => {
    ...
    // Initial resize after delays to ensure canvas is mounted and has dimensions
    setTimeout(() => {
      handleResize()
    }, 100)
